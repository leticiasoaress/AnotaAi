        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValorPago = table.Column<decimal>(type: "decimal(15,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comanda_Status_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Status",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comanda_Usuario_UsuarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comanda_StatusId",
                table: "Comanda",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_Comanda_UsuarioId",
                table: "Comanda",
                column: "UsuarioId");
